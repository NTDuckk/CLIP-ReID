...
# Shape-Aware Contrastive Prompt (PP4)
_C.MODEL.SHAPE_DIM = 256
_C.MODEL.SHAPE_ID_LOSS_WEIGHT = 0.25
_C.MODEL.SHAPE_TRI_LOSS_WEIGHT = 0.5
_C.MODEL.SHAPE_CONSISTENCY_LOSS_WEIGHT = 0.1
