...
_C.SOLVER.STAGE15 = CN()
_C.SOLVER.STAGE15.IMS_PER_BATCH = 64
_C.SOLVER.STAGE15.OPTIMIZER_NAME = "Adam"
_C.SOLVER.STAGE15.BASE_LR = 0.00035
_C.SOLVER.STAGE15.WARMUP_LR_INIT = 0.00001
_C.SOLVER.STAGE15.LR_MIN = 1e-6
_C.SOLVER.STAGE15.WARMUP_METHOD = 'linear'
_C.SOLVER.STAGE15.WEIGHT_DECAY = 1e-4
_C.SOLVER.STAGE15.WEIGHT_DECAY_BIAS = 1e-4
_C.SOLVER.STAGE15.MAX_EPOCHS = 30
_C.SOLVER.STAGE15.CHECKPOINT_PERIOD = 30
_C.SOLVER.STAGE15.LOG_PERIOD = 50
_C.SOLVER.STAGE15.WARMUP_EPOCHS = 5
_C.SOLVER.STAGE15.MOMENTUM = 0.9
_C.SOLVER.STAGE15.SHAPE_T = 4.0
_C.SOLVER.STAGE15.SHAPE_TAU = 0.6
_C.SOLVER.STAGE15.LAMBDA_SHAPE_DISTILL = 1.0
_C.SOLVER.STAGE15.LAMBDA_ALIGN = 0.1
